 ...
 */
public final class Pictur implements ActionListener {
   ...
   /**
    ...
    public static void main(String[] args) {
        Pictures pic = new Pictures(args[0]);
